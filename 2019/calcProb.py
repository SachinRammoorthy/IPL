...
for filename in os.listdir("/Users/sachin_rammoorthy/Downloads/ipl_csv/2019"):
    matchNumber = "Nope"
    season = ""
    actual = ""
    if filename.endswith(".csv") and "_1" not in filename:
...
print("\n\nBatsmen Ratings: \n")
print playerRatingsBatsmen
for i in playerRatingsBatsmen:
    print i
    if "1500" in i or int(i[2]) < 300:
        playerRatingsBatsmen.remove(i)
